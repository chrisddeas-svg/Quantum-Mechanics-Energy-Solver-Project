{
 "cells": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "93401680-a288-44d7-b0d6-a9ca7c75eef8",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "775daf60-a797-4a98-b231-76a700d38c1e",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "bf6130cc-04f3-4517-bebd-e4c6bfeca3d6",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "d361ca81-0fdd-4d30-ab94-83e1090283dd",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "3b3c27e4-5865-47c4-8776-55e0ee1fc29e",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "f4387868-2174-472b-ab38-90ddbb2c0008",
   "metadata": {},
   "outputs": [],
   "source": [
    "dx = x[1] - x[0]"
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "constant_V = float(input(\"V(x) = \"))\n",
    "Potencial_Function = np.full(Nx, constant_V)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "V_Matrix = np.diag(Potencial_Function) "
   ]
  },
  {
   "cell_type": "code",
